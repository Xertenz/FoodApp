  ...
  return (
    <div className="container my-5 add-recipe">
      <form method="POST" onSubmit={handleSubmit} encType="multipart/form-data">
        ...
        <div className="mb-3">
          <input type="file" name="coverImage" onChange={handleChange} className="form-control rounded-0" />
        </div>
        <div>
          <button type="submit" className="btn btn-primary rounded-0 add-recipe-submit">Add</button>
        </div>
      </form>
